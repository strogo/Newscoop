...
X_AUDIT(<*31*>, <*getGS('Article $1 added to $2. $3 from $4. $5 of $6',decS($cName),getHVar($q_sect,'Number'),getHVar($q_sect,'Name'),getHVar($q_iss,'Number'),getHVar($q_iss,'Name'),getHVar($q_pub,'Name')  )*>)
<? } else { ?>dnl
