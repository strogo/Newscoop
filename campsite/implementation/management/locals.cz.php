...
regGS("Login failed","Pøihlá¹ení neprobìhlo");
regGS("Pease make sure that you typed the correct user name and password.","Zkontrolujte, zda jste správnì zadali u¾ivatelské jméno a heslo");
regGS("If your problem persists please contact the site administrator $1","Pokud va¹e problémy pøetrvávají, prosím kontaktujte administrátora");
