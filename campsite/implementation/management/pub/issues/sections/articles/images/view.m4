...
X_CURRENT(<*Image:*>, <*<B><? pgetHVar($q_img,'Description'); ?></B>*>)
E_CURRENT

<P>
<CENTER><IMG SRC="/cgi-bin/get_img?IdPublication=<? p($Pub); ?>&NrIssue=<? p($Issue); ?>&NrSection=<? p($Section); ?>&NrArticle=<? p($Article); ?>&NrImage=<? p($Image); ?>" BORDER="0" ALT="<? pgetHVar($q_img,'Description'); ?>">
