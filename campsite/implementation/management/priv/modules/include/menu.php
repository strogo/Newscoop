...
if (1) { 
	...
	if ($User->hasPermission("ManagePhorum")) { 
	...
	if ($User->hasPermission("ManagePoll")) { 
	...
	if ($User->hasPermission("ManageTimer")) { 
	...
	if ($User->hasPermission("VotingRes")) { 
	...
	if ($User->hasPermission("ManageNewsletter")) { 
	...
	if ($User->hasPermission("ModerateArticleComments")) { 
	...
	if ($User->hasPermission("ManageSearchtracker")) { 
	...
	if ($User->hasPermission("ProfileAttributes")) { 
